...
# install.assert.sh — Post-install assertions for the omp adapter.
# Verifies that ~/.omp/agent/extensions/atrium.ts exists, carries the
...
EXT_FILE="${HOME}/.omp/agent/extensions/atrium.ts"
